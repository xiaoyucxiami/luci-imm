...
return view.extend({
	...
	render: function() {
		...
		o.default = _('Changing the accounting interval type will invalidate existing databases!<br /><strong><a href="%s">Download backup</a></strong>.').format(L.url('admin/network/nlbw/backup'));
		o.rawhtml = true;
